...
config.bind('<Ctrl+Shift+f>', 'hint links spawn --detach mpv --ytdl-format="((bestvideo[height<=?1080][vcodec!=vp9]/bestvideo[height<=?1080])+bestaudio)/best" --ytdl-raw-options=add-header="Cookie:",external-downloader=aria2c,external-downloader-args="-c -j 5 -x 4 -s 5 -k 10M" --profile=big-cache --loop-playlist --force-window \'{hint-url}\'')

config.bind('<Ctrl+Shift+c>', 'hint links spawn --detach mpv --ytdl-format="((bestvideo[height<=?1080][vcodec!=vp9]/bestvideo[height<=?1080])+bestaudio)/best" --ytdl-raw-options=add-header="Cookie:",external-downloader=aria2c,external-downloader-args="-c -j 5 -x 4 -s 5 -k 10M" --profile=big-cache --loop-playlist --force-window \'{url}\'')



#config.bind('<Ctrl+Shift+f>', 'hint all spawn --detach smplayer \'{hint-url}\'')
#config.bind('<Ctrl+Shift+c>', 'spawn --detach smplayer \'{url}\'')

config.bind('<Ctrl+Shift+a>', 'hint links spawn --detach firefox-developer-edition https://sci-hub.se/\'{hint-url}\'')
config.bind('<Ctrl+Alt+a>', 'hint links spawn --detach firefox-developer-edition \'{hint-url}\'')
